...
- **4.1 Component, Container, Window, Frame, Panel, Use of AWT Controls: Labels, Buttons, Checkbox, Checkbox Group, TextField, TextArea**
    ...
    - _Resource_: [AWT Tutorial - Tutorialspoint](https://www.tutorialspoint.com/awt/index.htm)​
        
- **4.2 Use of Layout Managers: FlowLayout, BorderLayout, GridLayout, GridBagLayout, MenuBars, Menus, File Dialog**
    
    - _Resource_: [AWT Layouts in Java - Tutorialspoint](https://www.tutorialspoint.com/awt/awt_layouts.htm)​
        
- **4.3 Introduction to Swing: Swing Features, Difference Between AWT and Swing**
    
    - _Resource_: [Swing Overview - Tutorialspoint](https://www.tutorialspoint.com/swing/swing_overview.htm)​
        
- **4.4 Swing Components: Icons and Labels, TextField, ComboBox, Button, Checkbox, RadioButton**
    
    - _Resource_: [Swing Tutorial - Tutorialspoint](https://www.tutorialspoint.com/swing/index.htm)
...
- **4.6 Introduction to Event Handling: The Delegation Event Model: Event Sources, Event Listeners**
    ...
    - _Resource_: [Introduction to Event Listeners - Java™ Tutorials](https://docs.oracle.com/javase/tutorial/uiswing/events/intro.html)

- **4.7 Event Classes: The ActionEvent Class, The ItemEvent Class, The KeyEvent Class, The MouseEvent Class, TextEvent**
    
    - _Resource_: [Lesson: Writing Event Listeners - Java™ Tutorials](https://docs.oracle.com/javase/tutorial/uiswing/events/index.html)​
    
- **4.8 Event Listener Interfaces: ActionListener, ItemListener, KeyListener, MouseListener, MouseMotionListener, TextListener**
...
- **5.1 Socket Overview: Client/Server, Reserved Sockets, Proxy Servers, Internet Addressing**
    ...
    - _Resource_: [All About Sockets (The Java™ Tutorials > Custom Networking)](https://docs.oracle.com/javase/tutorial/networking/sockets/index.html)
        
- **5.2 Java and the Net: The Networking Classes and Interfaces, InetAddress: Factory Methods, Instance Methods**
    
    - _Resource_: [Networking in Java: A Deep Dive into Sockets, URLs, and HTTP](https://www.maasmind.com/blog/networking-in-java-a-deep-dive-into-sockets-urls-and-http/)​
        
- **5.3 TCP/IP Client and Server Sockets, Datagram Sockets, Datagram Packets**
    
    - _Resource_: [Java Networking - Jenkov.com](https://jenkov.com/tutorials/java-networking/index.html)​
        
- **5.4 The URL Class, URLConnection Class**
    
    - _Resource_: [Reading from and Writing to a URLConnection](https://docs.oracle.com/javase/tutorial/networking/urls/readingWriting.html)
    
**Unit VI: Interacting with Database**

- **6.1 Introduction to JDBC, ODBC**
    
    - _Resource_: [Lesson: JDBC Basics - Java™ Tutorials](https://docs.oracle.com/javase/tutorial/jdbc/basics/index.html)​
- **6.2 JDBC Architecture: Two-Tier and Three-Tier Models**
    
    - _Resource_: [Architecture of ODBC and JDBC - IBM](https://www.ibm.com/docs/sl/SSULQD_7.1.0/com.ibm.nz.datacon.doc/c_datacon_architecture.html)​
        
- **6.3 Types of JDBC Drivers, Class Class, DriverManager Class, Connection Interface, Statement Interface, PreparedStatement Interface, ResultSet Interface**
    
    - _Resource_: [JDBC Tutorial - Tutorialspoint](https://www.tutorialspoint.com/jdbc/index.htm)​
        

**Additional Video Resource**

- _Topic_: JDBC-ODBC Bridge Architecture​
    
    - _Resource_: [JDBC-ODBC Bridge Architecture (in Java Database Connectivity) - YouTube](https://www.youtube.com/watch?v=aMxuApxIIP8)​